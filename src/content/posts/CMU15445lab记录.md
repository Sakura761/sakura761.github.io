...
更多关于ARC算法，可以看看[这篇博客](/posts/arc-algorithm/)

这个任务只要理解了ARC算法，还是比较容易的
需要注意的地方是需要保证线程安全，还有一个性能测试，注意不能用list.remove删除list中的元素，这是O(n)复杂度，我们需要保存迭代器，直接用erase删除，这是O(1)复杂度
